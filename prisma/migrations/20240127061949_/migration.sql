...
CREATE TABLE "Tenement_Market" (
    ...
    "tenement_area_max" TEXT NOT NULL,
    "tenement_area_min" TEXT NOT NULL,
    "burget_rent_max" TEXT NOT NULL,
    "burget_rent_min" TEXT NOT NULL,
    "hopefloor_max" TEXT NOT NULL,
    "hopefloor_min" TEXT NOT NULL,
...
CREATE TABLE "Tenement_Create" (
    ...
    "main_building" TEXT NOT NULL,
    "inside_rating" TEXT NOT NULL,
    "affiliated_building" TEXT NOT NULL,
    "public_building" TEXT NOT NULL,
    "unregistered_area" TEXT NOT NULL,
    "management_magnification" TEXT NOT NULL,
    "management_fee" TEXT NOT NULL,
    "tenement_floor" TEXT NOT NULL,
    "tenement_host_name" TEXT NOT NULL,
    "tenement_host_telphone" TEXT NOT NULL,
    "tenement_host_phone" TEXT NOT NULL,
    "tenement_host_line" TEXT NOT NULL,
